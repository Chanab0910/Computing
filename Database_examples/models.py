...
book_author = Table("book_author", Base.metadata, Column('book_id', ForeignKey('book.book_id')),
                    Column('author_id', ForeignKey("author.author_id")), UniqueConstraint('book_id', 'author_id'))

book_loan = Table("book_loan", Base.metadata, Column('book_id', ForeignKey('book.book_id')),
                  Column('person_id', ForeignKey("person.person_id")), UniqueConstraint('book_id', 'person_id'))
